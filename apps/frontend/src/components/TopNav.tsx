        ...
        <div className="d-flex align-items-center" style={{ gap: '16px', paddingLeft: '16px' }}>
          ...
          <Navbar.Brand href="/" className="d-flex align-items-center">
            <img
              ...
              srcSet="/images/logo/logo.png 1x, /images/logo/logo_2x.png 2x, /images/logo/logo_3x.png 3x"
              alt="Lomen Club"
              style={{
                height: '40px',
                width: 'auto',
                transition: 'all 150ms cubic-bezier(0.4, 0, 0.2, 1)',
                filter: 'drop-shadow(0 2px 4px rgba(35, 175, 145, 0.2))'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.05)';
                e.currentTarget.style.filter = 'drop-shadow(0 4px 8px rgba(35, 175, 145, 0.3))';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1)';
                e.currentTarget.style.filter = 'drop-shadow(0 2px 4px rgba(35, 175, 145, 0.2))';
              }}
            />
          </Navbar.Brand>
        </div>
