...
## Purpose
Preserve legacy OCI deployment guidance.

## Audience
Operators reviewing prior OCI setup steps.

## Prerequisites
OCI account and CLI access.

## Status
Archived. See `docs/deployment/environments.md` for current deployment notes.
