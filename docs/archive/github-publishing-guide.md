...
## Purpose
Preserve a legacy guide for initial GitHub publishing steps.

## Audience
Maintainers reviewing historical setup instructions.

## Prerequisites
None.

## Status
Archived. Use current repo onboarding and contribution docs instead.
